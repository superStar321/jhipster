...
import { GuestUserComponent } from 'app/entities/guest-user/guest-user.component';
...
describe('Component Tests', () => {
    describe('GuestUser Management Component', () => {
        let comp: GuestUserComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GuestUserComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.guestUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
