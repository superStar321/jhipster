...
import { GRoleComponent } from 'app/entities/g-role/g-role.component';
import { GRoleService } from 'app/entities/g-role/g-role.service';
import { GRole } from 'app/shared/model/g-role.model';

describe('Component Tests', () => {
    describe('GRole Management Component', () => {
        let comp: GRoleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GRoleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gRoles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
