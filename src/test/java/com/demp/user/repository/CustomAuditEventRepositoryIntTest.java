...
import com.demp.user.config.audit.AuditEventConverter;
import com.demp.user.domain.PersistentAuditEvent;
...
import static com.demp.user.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
