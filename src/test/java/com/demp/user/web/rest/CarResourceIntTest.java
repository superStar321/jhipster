...
public class CarResourceIntTest {
    ...
    private static final String DEFAULT_CAR_BRAND = "AAAAAAAAAA";
    private static final String UPDATED_CAR_BRAND = "BBBBBBBBBB";
    ...
    public void getAllCars() throws Exception {
        ...
        restCarMockMvc.perform(get("/api/cars?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].carName").value(hasItem(DEFAULT_CAR_NAME.toString())))
    ...
    public void getCar() throws Exception {
        ...
        restCarMockMvc.perform(get("/api/cars/{id}", car.getId()))
            ...
            .andExpect(jsonPath("$.carName").value(DEFAULT_CAR_NAME.toString()))
